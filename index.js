...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '😌🤳𝗥𝗟𝗫 𝗔𝗜 𝗠𝗔𝗡𝗢 𝗧𝗢 𝗙𝗔𝗭𝗘𝗡𝗗𝗢 𝗔𝗤𝗨𝗜 𝗦𝗘 𝗗𝗔 𝗘𝗥𝗥𝗢 𝗦𝗘 𝗧𝗘𝗡𝗧𝗔 𝗗𝗘 𝗡𝗢𝗩𝗢.....',
				success: '✔️Sucesso✔️',
                                levelon: '❬ ✔ ❭ *habilitar Level*',
				leveloff: ' ❬ X ❭  *desabilitar Level*',
				levelnoton: '❬ X ❭ *level não ativo ativa ai mano *',
				levelnol: '*Pqp kskst level* 0 ',
				error: {
					stick: '[❗]🐒 Falha, ocorreu um erro ao converter a imagem em um adesivo ❌',
					Iv: '❌ Link inválido so images n video caralho 🤳😌❌'
				},
				only: {
					group: '[❗]🐒 Este comando só pode ser usado em grupos brow! ❌',
					ownerG: '[❗]🐒 Este comando só pode ser usado pelo grupo proprietário! ❌',
					ownerB: '[❗]🐒 Este comando só pode ser usado pelo kick-ass! ❌',
					admin: '[❗]🐒 Este comando só pode ser usado por administradores de grupo hehe! ❌',
					Badmin: '[❗]🐒 Este comando só pode ser usado quando o bot se torna administrador coloca adm ai! ❌',
			       ...
			       reply(anu.result.jadwalTV)
					break
                                ...
                                case 'burnpaper':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`onde está o texto hum\nExemplo: ${prefix}burnpaper KICK-ASS-BOT`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'lovepaper':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`onde está o texto hum\nExemplo: ${prefix}lovepaper KICK-ASS-BOT`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'qowheart':
                                        var gh = body.slice(9)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`onde está o texto hum\nExemplo: ${prefix}qowheart KICK-ASS-BOT`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'undergocean':
                                        var gh = body.slice(12)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`onde está o texto hum\nExemplo: ${prefix}undergocean KICK-ASS-BOT`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'metalictglow':
                                        ...
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`onde está o texto hum\nExemplo: ${prefix}metalictglow KICK-ASS-BOT`)
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
				...
				case 'clone':
					...
					break
                                ...
                                case 'pubglogo':
                                        ...
                                        var teks1 = gh.split("|")[0];
                                        var teks2 = gh.split("|")[1];
                                        if (args.length < 1) return reply(`onde está o texto hum\nExemplo: ${prefix}pubglogo KICK|ASS`)
                                        if (!isUser) return reply(mess.only.daftarB)
